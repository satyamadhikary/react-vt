    ...
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      <SidebarProvider>
        ...
        <Drawer open={isDrawerOpen} onClose={() => setIsDrawerOpen(false)}>
          ...
          <DrawerContent>
         <video style={{width: "100vw",objectFit: "fill", height: "100%", position: "absolute", zIndex: "-2", filter: "blur(10px)"}} autoPlay={true} loop src="https://firebasestorage.googleapis.com/v0/b/flute-8592b.appspot.com/o/drawerVideo%2Funwatermark_istockphoto-1317284271-640_adpp_is.mp4?alt=media&token=44d5a9af-59b0-41a6-8b6c-0d96e1c4e6d5"></video>
            {currentAudio ? (
